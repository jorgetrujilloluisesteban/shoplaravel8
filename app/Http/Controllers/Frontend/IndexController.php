...
class IndexController extends Controller
{
    ...
    public function ProductDetails($id,$slug){
        ...
        //return view('frontend.product.product_details',compact('product','multiImag','product_color_en','product_size_en'));
    ...
    public function TagWiseProduct($tag){
        //$products = Product::where('status',1)->where('product_tags_en',$tag)->where('product_tags_es',$tag)->orderBy('id','DESC')->get();
