...
class SubCategoryController extends Controller
{
    ...
    public function SubCategoryStore(Request $request){
    	...
    	$request->validate([
    		...
    		'subcategory_name_es.required' => 'Input Sub Category Spanish Name',
    	]);
    	...
    	SubCategory::insert([
    		...
    		'subcategory_slug_es' => strtolower(str_replace(' ','-',$request->subcategory_name_es)),
    	]);
    ...
    public function SubSubCategoryStore(Request $request){
        ...
        $request->validate([
            ...
            'category_id.required' => 'Please select Any option',
            'subsubcategory_name_en.required' => 'Input SubSub Category English Name',
            'subsubcategory_name_es.required' => 'Input SubSub Category Spanish Name',
        ]);
        ...
        SubSubCategory::insert([
            ...
            'subsubcategory_slug_es' => strtolower(str_replace(' ','-',$request->subsubcategory_name_es)),
        ]);
