...
<div class="row"> <!-- start 2nd row  -->
 ...
 <option value="{{ $subsub->id }}" {{ $subsub->id == $products->subsubcategory_id ? 'selected': '' }} >{{ $subsub->subsubcategory_name_en }}</option>	
	 ...
	 @enderror
			...
			<div class="controls">
				<!--<input type="text" name="product_name_es" class="form-control" required="">-->
				<input type="text" name="product_name_es" class="form-control" required=""  value="{{ $products->product_name_es }}">
...
<div class="row"> <!-- start 4th row  -->
	    ...
	    <div class="form-group">
			...
			<div class="controls">
	 <!--<input type="text" name="product_tags_es" class="form-control" value="Lorem,Ipsum,Amet" data-role="tagsinput" required="">-->
	 <input type="text" name="product_tags_es" class="form-control" value="{{ $products->product_tags_es }}" data-role="tagsinput" required="">
	 ...
	 @enderror
			...
			<div class="controls">
	 <!--<input type="text" name="product_size_es" class="form-control" value="Small,Midium,Large" data-role="tagsinput" required="">-->
	 	 <input type="text" name="product_size_es" class="form-control" value="{{ $products->product_size_es }}" data-role="tagsinput">
...
<div class="row"> <!-- start 5th row  -->
	 ...
	 @enderror
			...
			<div class="controls">
	 <!--<input type="text" name="product_color_es" class="form-control" value="red,Black,Large" data-role="tagsinput" required="">-->
	 	 <input type="text" name="product_color_es" class="form-control" value="{{ $products->product_color_es }}" data-role="tagsinput" required="">
	...
	<textarea name="short_descp_en" id="textarea" class="form-control" required placeholder="Textarea text">
		{!! $products->short_descp_en !!}
	     ...
	     <div class="form-group">
			...
			<div class="controls">
	<!--<textarea name="short_descp_es" id="textarea" class="form-control" required placeholder="Textarea text"></textarea>-->
	<textarea name="short_descp_es" id="textarea" class="form-control" required placeholder="Textarea text">
		{!! $products->short_descp_es !!}
	</textarea>    
	 		 </div>
		</div>
	...
	<textarea id="editor1" name="long_descp_en" rows="10" cols="80" required="">
		...
		{!! $products->long_descp_en !!}
	     ...
	     <div class="form-group">
			...
			<div class="controls">
	<textarea id="editor2" name="long_descp_es" rows="10" cols="80">
		<!--Long Description Esp-->
		{!! $products->long_descp_es !!}
						</textarea>       
	 		 </div>
		</div>
